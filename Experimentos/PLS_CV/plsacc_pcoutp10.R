...
trainData <- trainData[outlier_list$pcoutlierp10 == FALSE,]
trainClass <- trainClass[outlier_list$pcoutlierp10 == FALSE]
...
confusionMatrix(as.factor(testClass),as.factor(apply(ypred[,ncomp,],1,which.max))) #72,45%   
