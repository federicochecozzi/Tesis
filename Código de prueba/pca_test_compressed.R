...
trainClass <- as.data.frame(h5read(file = "train_d8_sc250_harder.h5", name = "Class")) # import classes
trainData <- h5read(file = "train_d8_sc250_harder.h5", name = "Spectra") # import spectra
h5closeAll()
...
end_time - start_time#33.47537 mins
...
end_time - start_time#2.011074 hours