...
setwd("C:/Users/tiama/OneDrive/Documentos/Maestría en minería y exploración de datos/Tesis de maestría/Scripts/Código de prueba/")
pdf("output/train_spectral_plots.pdf")

for (i in 1:ncol(trainData)) {
  print(i)
  p <- ggplot() + 
    geom_line(aes(x = wavelengths$X1, y = trainData[,i])) +
    ggtitle(paste("Class:",as.character(trainClass[i])))
  print(p)
}
